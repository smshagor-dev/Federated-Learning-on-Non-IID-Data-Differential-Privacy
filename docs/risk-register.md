...
| R5 | No checkpoint recovery | High | Medium | None | Add coordinator checkpointing in a later phase |
...
| R8 | Large infrastructure scope can cause phase sprawl | High | High | Foundation phase constrained to scaffolding | Release gates per phase |
