"""Coordinator Runtime phase PyTorch worker: real gRPC/CLI-bridge coordinator client,
real local training (FedAvg/FedProx/SCAFFOLD, reusing federated.client),
and the worker execution loop.

Supersedes the Aggregation-Core-era placeholder in ``fl_platform.workers``
