"""Publication-oriented aggregation of repeated benchmark observations."""
...
def validate_publication_observations(
    ...
    *,
    ...
    if insufficient:
        raise ValueError(
            "publication observations do not meet the minimum replicate count: "
            f"{insufficient}"
        )
    return normalized
...
def summarize_observations(
    ...
    *,
    ...
    normalized = validate_publication_observations(
